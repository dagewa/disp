/* compiled code implementing the decompression algorithm for images using miniCBF "byte_offset" decompression */
/* this function is called by readP6M using the .C interface. */
